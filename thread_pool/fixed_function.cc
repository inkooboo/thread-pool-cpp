...
module thread_pool.fixed_function;
...
export {
    ...
    public:
        /**
         * @brief FixedFunction Default constructor.
         * Construct empty function object whith no functional object stored.
         */
        FixedFunction();
...
template <typename R, typename... ARGS, size_t STORAGE_SIZE>
inline FixedFunction<R(ARGS...), STORAGE_SIZE>::FixedFunction()
...
template <typename R, typename... ARGS, size_t STORAGE_SIZE>
template <typename FUNC>
inline FixedFunction<R(ARGS...), STORAGE_SIZE>::FixedFunction(FUNC &&object)
{
...
template <typename R, typename... ARGS, size_t STORAGE_SIZE>
template <typename RET, typename... PARAMS>
inline FixedFunction<R(ARGS...), STORAGE_SIZE>::FixedFunction(RET(*func_ptr)(PARAMS...))
{
...
template <typename R, typename... ARGS, size_t STORAGE_SIZE>
inline FixedFunction<R(ARGS...), STORAGE_SIZE>::FixedFunction(FixedFunction &&o)
{
    moveFromOther(o);
}

template <typename R, typename... ARGS, size_t STORAGE_SIZE>
inline FixedFunction<R(ARGS...), STORAGE_SIZE> & FixedFunction<R(ARGS...), STORAGE_SIZE>::operator=(FixedFunction<R(ARGS...), STORAGE_SIZE> &&o)
{
    moveFromOther(o);
    return *this;
}
...
template <typename R, typename... ARGS, size_t STORAGE_SIZE>
inline R FixedFunction<R(ARGS...), STORAGE_SIZE>::operator()(ARGS... args)
{
    if (!m_method_ptr)
...
template <typename R, typename... ARGS, size_t STORAGE_SIZE>
inline void FixedFunction<R(ARGS...), STORAGE_SIZE>::moveFromOther(FixedFunction &o)
{
    if (this == &o)
        return;
